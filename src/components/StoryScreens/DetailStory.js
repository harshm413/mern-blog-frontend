...
const DetailStory = () => {
        ...
        const getDetailStory = async () => {
            ...
            try {
                const { data } = await axios.get(
                    'https://mern-blog-backend-nc2o.onrender.com/auth/private',
                    {
                        headers: {
            ...
            try {
                const { data } = await axios.post(
                    `https://mern-blog-backend-nc2o.onrender.com/story/${slug}`,
                    {
                        activeUser,
                    }
                );
    ...
    const handleLike = async () => {
        ...
        try {
            const { data } = await axios.post(
                `https://mern-blog-backend-nc2o.onrender.com/story/${slug}/like`,
                { activeUser },
                {
                    headers: {
                        'Content-Type': 'application/json',
    ...
    const handleDelete = async () => {
        if (window.confirm('Do you want to delete this post')) {
            try {
                await axios.delete(
                    `https://mern-blog-backend-nc2o.onrender.com/story/${slug}/delete`,
                    {
                        headers: {
                            'Content-Type': 'application/json',
                            authorization: `Bearer ${localStorage.getItem(
    ...
    const addStoryToReadList = async () => {
        try {
            const { data } = await axios.post(
                `https://mern-blog-backend-nc2o.onrender.com/user/${slug}/addStoryToReadList`,
                { activeUser },
                {
                    headers: {
                        'Content-Type': 'application/json',
